...
# -*- coding: utf-8 -*-
# run_GPU_P3-512.py — P3-512 실험 런너
# SwissProt 제거 + embedding 256→512 확장
#
# dim sweep 비교:
#   v8b      (SP✓, 64d):  Macro=0.357  [완료]
#   P3       (SP✗, 64d):  Macro=0.298  [완료]
#   P3-256   (SP✗, 256d): Macro=0.355  [완료]
#   v8b-D256 (SP✓, 256d): Macro=0.384  [완료]
#   P3-512   (SP✗, 512d): [본 실험]  ← PCA 91% ceiling 목표
#   ESM-2 LR (640d,human): Macro=0.561 ← 목표 상한
#
# Selective best:
#   P3-256 (Type-B) + D256 (Type-A) = 0.4365 [현재 best]
#   기대: P3-512 (Type-B) + D256 (Type-A) ≈ 0.49~0.53
...
VERSION_TAG  = 'P3-512'
MODEL_SCRIPT = 'v8b-P3-512_integrated_full_model.py'
GPU_LIST     = [0, 1]
...
def run_model_on_gpu(go_terms, gpu_id):
    ...
    print("=" * 65)
    print(" [GPU {}] P3-512 (SwissProt✗ + dim512) — {} GO terms".format(gpu_id, total))
    print("=" * 65)
...
if __name__ == '__main__':
    ...
    print("=" * 65)
    print(" P3-512 — SwissProt✗ + embedding 256→512 — Dual GPU")
    print(" Total GO terms: {}".format(total))
    print(" GPU 0 -> {}".format(gpu0_terms))
    print(" GPU 1 -> {}".format(gpu1_terms))
    print(" dim sweep 누적 비교:")
    print("   v8b      (SP✓,  64d): Macro=0.357  [완료]")
    print("   P3       (SP✗,  64d): Macro=0.298  [완료]")
    print("   P3-256   (SP✗, 256d): Macro=0.355  [완료]")
    print("   v8b-D256 (SP✓, 256d): Macro=0.384  [완료]")
    print("   P3-512   (SP✗, 512d): [본 실험]  ← PCA 91% ceiling")
    print("   ESM-2 LR (640d,human): Macro=0.561 ← 목표 상한")
    print(" Selective best now: P3-256(Type-B) + D256(Type-A) = 0.4365")
    print("=" * 65)
