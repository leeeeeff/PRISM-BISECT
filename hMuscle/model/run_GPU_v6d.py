...
# -*- coding: utf-8 -*-
"""
run_GPU_v6d.py — v6-domain-delta (DomainDelta branch)) 실행 스크립트
...
VERSION_TAG  = 'v6d'
MODEL_SCRIPT = "v6d_integrated_full_model.py"
...
if __name__ == '__main__':
    print("=" * 56)
    print(" v6-domain-delta (DomainDelta branch)) GPU Runner")
    print("=" * 56)
