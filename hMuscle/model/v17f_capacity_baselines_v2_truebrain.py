...
OUT_DIR   = '../../reports/truebrain_rerun_20260714/v17f_capacity_baselines'
os.makedirs(OUT_DIR, exist_ok=True)

SEEDS      = [42, 7, 13, 21, 99]
BATCH_MLP  = 512
EPOCHS_MLP = 60
VSTAR_REF  = 0.6471   # TRUE-BRAIN v17f* point estimate (v17f_star_bootstrap_ci_v2_truebrain.py,
                       # 2026-07-14; muscle-mislabeled-as-brain reference was 0.7343 -- see
                       # reports/truebrain_rerun_20260714/v17f_star_bootstrap/v17f_star_ci.json
                       # for the final bootstrap CI once available)
...
X_l25_te = np.load(f'{BRAIN_DIR}/brain_full_esm2_layer25_t30_150M.npy').astype(np.float32)
