...
v15d_bp_clean.py
=================
v15d_unified 기반. CC/MF term을 동등한 BP term으로 교체.

교체:
  GO:0030017 Sarcomere (CC)         → GO:0045214 sarcomere organization (BP)
  GO:0003774 Motor activity (MF)    → GO:0030048 actin-based movement (BP)
  GO:0043005 Neuron projection (CC) → GO:0031175 neuron projection development (BP)

목적: 18 GO term 전체 BP-only 구성 + unified annotation → 리뷰어 방어 가능한 GO term set
"""
...
GO_TERMS = {
    ...
    'GO:0045214': 'Sarcomere organization',   # GO:0030017(CC) → BP
    ...
    'GO:0030048': 'Actin-based movement',     # GO:0003774(MF) → BP
    'GO:0006096': 'Glycolysis',
    # --- 신경/세포골격 (BP-only, 5개) ---
    'GO:0007268': 'Synaptic transmission',
    'GO:0007018': 'MT-based movement',
    'GO:0031175': 'Neuron proj development',  # GO:0043005(CC) → BP
...
# ── Load features ─────────────────────────────────────────────────────────────
print("="*70)
print("  v15d_bp_clean Cross-GO Functional Switch — BP-only (18 terms)")
print("="*70)
