...
# -*- coding: utf-8 -*-
# run_GPU_v8-3.py — v8-3 실험 런너
#
# v8-3 전략:
#   Type-B: Phase 1 → Phase 3 (Balanced LR, Phase 2 skip)
#   Type-A: Phase 1 → Phase 2 (v8b 동일)
# 5개 GO term 두 GPU 분산
...
VERSION_TAG  = 'v8-3'
MODEL_SCRIPT = 'v8-3_integrated_full_model.py'
GPU_LIST     = [0, 1]
...
def run_model_on_gpu(go_terms, gpu_id):
    ...
    print("=" * 53)
    print(" [GPU {}] v8-3 (Balanced LR) — {} GO terms".format(gpu_id, total))
    print("=" * 53)
...
if __name__ == '__main__':
    ...
    print("=" * 53)
    print(" v8-3 (Balanced LR, Phase2 skip for Type-B)")
