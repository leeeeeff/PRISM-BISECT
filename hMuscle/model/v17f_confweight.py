...
N_SEED   = 5
ALPHA_W  = 0.5       # floor for confidence weight (0 = full suppression, 1 = no effect)
N_CDD    = 512
...
np.save('../../reports/v17f_confweight_preds.npy', ens_pred)
...
print("\nDone. Results saved to reports/v17f_confweight_preds.npy")
