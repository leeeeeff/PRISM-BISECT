...
# -*- coding: utf-8 -*-
"""
run_GPU_v6g.py — v6g (v6e + lr/patience/coverage fix) 실행 스크립트

v6g 핵심 변경 (v6e 대비):
  - [v6g-1] Type-B Phase2 lr: 0.0001 → 0.0002 (GO:0006941 수렴 속도 확보)
  - [v6g-2] Type-B patience: 6 → 10, max_epochs: 15 → 25
  - [v6g-3] TARGET_COVERAGE: 4 → 6 원복 (GO:0006096 coverage 50% 감소 수정)
  - [v6g-4] [Final] patience 하드코딩 버그 수정

실행:
  cd hMuscle/model/
  python run_GPU_v6g.py
"""
...
if __name__ == '__main__':
    print("=" * 56)
    print(" v6g (v6e + lr/patience/coverage fix) GPU Runner")
    print("=" * 56)
    ...
    print("=" * 56)
    print("\n v6g 변경 사항 (v6e 대비):")
    print("  [v6g-1] Type-B Phase2 lr: 0.0001 → 0.0002")
    print("  [v6g-2] Type-B patience: 6 → 10, max_epochs: 15 → 25")
    print("  [v6g-3] TARGET_COVERAGE: 4 → 6 원복")
    print("  [v6g-4] [Final] patience 출력 버그 수정")
    print("=" * 56)
