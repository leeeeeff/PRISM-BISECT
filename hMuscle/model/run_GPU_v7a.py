...
# -*- coding: utf-8 -*-
"""
run_GPU_v7a.py — v7a (v6g + Supervised Contrastive Loss) 실행 스크립트

v7a 핵심 변경 (v6g 대비):
  - [v7a-1] Phase 1 손실: Triplet → SupCon (τ=0.1)
    수식: L_i = log Σ_{a≠i} exp(z_i·z_a/τ) − (1/|P(i)|) Σ_{p∈P(i)} z_i·z_p/τ
  - ablation Exp 2a: v7a-SupCon vs v6g Macro-AUPRC 비교

v6g 변경 유지:
  - [v6g-1] Phase 1.5 제거 | [v6f-1~4] lr/patience/coverage 수정

실행:
  cd hMuscle/model/
  python run_GPU_v7a.py
"""
...
if __name__ == '__main__':
    print("=" * 56)
    print(" v7a (v6g + SupCon Phase 1) GPU Runner")
    print("=" * 56)
    ...
    print("=" * 56)
    print("\n v7a 변경 사항 (v6g 대비):")
    print("  [v7a-1] Phase 1: Triplet → SupCon (τ=0.1)")
    print("  ablation Exp 2a: acceptance Δ Macro-AUPRC > +0.02 vs v6g(0.465)")
    print("=" * 56)
