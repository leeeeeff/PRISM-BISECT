...
분석 설계:
  - 뇌 테스트 세트 (36,748 아이소폼)의 InterProScan Pfam 도메인 개수를 ground truth로 사용
...
출력: reports/domain_ranking_validation/results.json
"""
...
DOMAIN_MAT   = '../results_isoform/features/domain_matrix_proper_test.npy'  # 36748×512 binary Pfam
