...
# -*- coding: utf-8 -*-
"""
run_GPU_v6h.py — v6-hybrid (Modality-Role Separation) 실행 스크립트

설계:
  - Phase 1: ESM-2 + Domain → triplet (CNN frozen)
  - Phase 1.5: 전체 frozen → Head focal 재조정
  - Phase 2: ESM-2 frozen → CNN + Domain focal (triplet 없음)
...
VERSION_TAG  = 'v6h'
MODEL_SCRIPT = 'v6h_integrated_full_model.py'
...
if __name__ == '__main__':
    print("=" * 56)
    print(" v6-hybrid (Modality-Role Separation) GPU Runner")
    print("=" * 56)
