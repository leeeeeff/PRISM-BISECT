...
v15d_expanded_go.py
====================
v15c 확장판: 신경/세포골격 GO term 5개 추가 (총 18개)
목적: KIF1B α vs β cross-GO reversal 포착 시도
     현재 13개 근육-편향 GO term set으로는 KIF1Bβ의 신경 기능 커버 불가

신규 GO term:
  GO:0007268  chemical synaptic transmission  (tr=262, KIF1B+)
  GO:0007018  microtubule-based movement      (tr=185, KIF1B+)
  GO:0043005  neuron projection               (tr=598, KIF1B+)
  GO:0030182  neuron differentiation          (tr=507)
  GO:0000226  microtubule cytoskeleton org    (tr=315)
"""
...
# ── Load features ─────────────────────────────────────────────────────────────
print("="*70)
print("  v15d Cross-GO Functional Switch — Expanded GO (18 terms)")
print("="*70)
