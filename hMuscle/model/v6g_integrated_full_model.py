# -*- coding: utf-8 -*-
# ============================================================================
# v6g_integrated_full_model.py  (v6f - Phase 1.5 제거)
#
# v6f 대비 핵심 변경:
# [v6g-1] Phase 1.5 (Linear Probing) 완전 제거
#   근거: Phase 1.5에서 feature_model frozen 선언에도 embedding이 실측 변화
#         (max_diff GO:0006941=0.52, GO:0003774=0.63). Linear Probe head가
#         Phase 1 Triplet이 구축한 metric space를 왜곡하는 것으로 판단.
#         v6f Macro-AUPRC=0.424 (v6 시리즈 최저) → Phase 1→2 직행으로 검증.
#
# v6f 변경사항 유지:
...
print("\n[Model v6g] ESM-2(640->64) + CNN(1500->32) + Domain(LSTM 16) + DomainDelta(251->16) -> concat[128]")
print("[Model v6g] Head: Dense(64) -> L2_norm -> emb[64] -> sigmoid")
print("[Model v6g] Phase 1: ESM-2 CNN(frozen) Domain DeltaBranch | Phase 2: ESM-2(frozen) CNN Domain DeltaBranch")
print("[Model v6g] v6f changes: TypeB lr=0.0002(0.0001), patience=10(6), max_epochs=25(15), coverage=6(4)")
...
# ==========================================================================
print("\n[v6g-1] Phase 1.5 SKIPPED — Phase 1 → Phase 2 direct")
...
print("    [v6g] Adaptive hyperparameter by GO term type")
print("=" * 55)
