...
Input:  reports/exp_e_sota/deepfri_MF_pred_scores.json
Output: reports/exp_e_sota/deepfri_auprc.json
"""
...
PRED_JSON = f'{OUT_DIR}/deepfri_MF_pred_scores.json'
...
d0_json = f'../../reports/exp_d_finetune/d0_bootstrap_ci.json'
