...
OUT_DIR    = '../../reports/truebrain_rerun_20260714/exp_a_cond_domain_aux'
...
dm_tr = np.load(f'{FEAT_DIR}/domain_matrix_proper_train.npy').astype(np.float32)  # (31668,512) -- train side UNCHANGED
dm_te = np.load(f'{FEAT_DIR}/domain_matrix_brain_full.npy').astype(np.float32)    # (63994,512) TRUE BRAIN, same 512-Pfam vocab as train
...
# TRUE BRAIN: brain_full_gene_names.npy already holds gene SYMBOLS directly.
