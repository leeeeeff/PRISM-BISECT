...
def load_sequence_data():
    ...
    X_test_seq = np.load('../results/amino_seq/protein_sequences.npy')
    ...
    X_test_geneid = np.load('../data/test_set/gene_list.npy')
    X_test_geneid = list(X_test_geneid)
    X_test_isoid = np.load('../data/test_set/isoform_list.npy')
...
co_exp_net = np.load('../results/co-expression_net/coexp_net.npy')
