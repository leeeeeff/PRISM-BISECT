# -*- coding: utf-8 -*-
# ============================================================================
# v6d_integrated_full_model.py  (v6-domain-delta)
#
# v6h 대비 핵심 추가:
...
try:
    ...
    print("Usage: python v6d_integrated_full_model.py <GO_TERM>")
    sys.exit(1)
...
# [8-v6h] 데이터 로딩
# --------------------------------------------------------------------------
print('>>> Preparing Data (v6d/DomainDelta) for ' + selected_go)
...
print("\n[Model v6d] ESM-2(640→64) + CNN(1500→32) + Domain(LSTM 16) + DomainDelta(251→16) → concat[128]")
print("[Model v6d] Head: Dense(64) → L2_norm → emb[64] → sigmoid")
print("[Model v6d] Phase 1: ESM-2✅ CNN❌ Domain✅ DeltaBranch✅ | Phase 2: ESM-2❌ CNN✅ Domain✅ DeltaBranch✅")
...
print("  [Phase1-v6d] CNN frozen | ESM-2+Domain+DeltaBranch trainable")
...
print("    [v6d] ESM-2 FROZEN | CNN+Domain+DeltaBranch TRAIN | Focal only")
print("    [I5] AUPRC early stop [R9.1] | patience=3 | alpha=0.10")
print("=" * 55)
...
print("  [Phase2-v6d] ESM-2 frozen | CNN + Domain + DeltaBranch trainable")
...
no_improve_count   = 0
NO_IMPROVE_LIMIT   = 7  # [v6d] patience 증가 (v6h=3 → 7)
